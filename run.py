...
twitch_miner = TwitchChannelPointsMiner(
    username="dotkaif",
    password="KLOCHKOV123",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1095399014775652423/_4WpIQThBnqEEd7l3nO1u9k7c0t0M0MIbvaqnoT2LmPZvCNnlmyZFQxmXefXRjEDdWEy", # Discord Webhook URL
            events=[
...
twitch_miner.mine(
    [
        Streamer("elwycco", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=True  , watch_streak=True )),
        Streamer("alcoreru", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=True  , watch_streak=True )),
        Streamer("mooniverse", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=True  , watch_streak=True )),
